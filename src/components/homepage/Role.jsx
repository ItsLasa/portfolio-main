...
export default function Role({forwardedRef}) {
  return (
    <section ref={forwardedRef} id="about" className="select-none  flex my-20 md:my-[12%]  py-24 flex-col items-center justify-center overflow-hidden nav-change" aria-label="">
